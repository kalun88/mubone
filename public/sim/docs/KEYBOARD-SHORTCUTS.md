...
| **`O`** | **overdub** at factory (2026-09-24) — the tape MODE, on and off; the letter the tape tile's flag draws. Learnable like any binding |
| **`P`** | **autopin as loop and cloud** at factory (2026-09-25) — both engines' autopin at once: on unless both already are, then off. A key learned onto either engine's own autopin row works beside it, and that row's sticker shows it in place of P |
