...
> **Status: ARCHIVED 2026-09-05** — the first export/import audit (`EXPORT_VERSION` 3); the format is `docs/EXPORT-IMPORT-AUDIT-2026-08.md`. Its 6-point verification checklist is still unrun and is TODO #138.
