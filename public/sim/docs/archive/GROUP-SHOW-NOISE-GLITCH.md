...
> **Status: ARCHIVED 2026-09-05** — the buffer-retention leak: investigation, fix, revert checklist. Its verification (§ Verification) is TODO #127; the fix itself shipped in 1.11.
